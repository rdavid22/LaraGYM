<!-- Section: Navigation -->
@if (Route::has('login'))
        <nav class="fixed top-0 flex w-full items-center justify-between  text-white focus:text-yellow-300 md:flex-wrap md:justify-start" data-te-navbar-ref>
            <div class="flex w-full flex-wrap items-center justify-between m-10">
                ...
                <div class="flex items-center">                      
                    <button class="border-0 bg-transparent py-5 leading-none transition-shadow duration-150 ease-in-out hover:text-yellow-300 focus:text-yellow-300 lg:hidden" type="button" data-te-collapse-init data-te-target="#navbarSupportedContentX" aria-controls="navbarSupportedContentX" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="!visible hidden grow basis-[100%] items-center lg:!flex lg:basis-auto" id="navbarSupportedContentX" data-te-collapse-item>
                    <ul class="mr-auto flex flex-col lg:flex-row text-3xl lg:space-x-10 lg:space-y-0 space-y-3" data-te-navbar-nav-ref>
                        ...
                        <li data-te-nav-item-ref>
                            <a
                                class="block transition duration-150 ease-in-out hover:text-yellow-300 focus:text-yellow-300 disabled:text-black/30 lg:p-2 [&.active]:text-black/90"
                                href="#!"
                                data-te-nav-link-ref
                                data-te-ripple-init
                                data-te-ripple-color="light">
